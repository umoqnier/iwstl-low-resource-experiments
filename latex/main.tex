...
\begin{frame}{Primera version}
     \centering
     \includegraphics[width=0.9\linewidth]{imagens/Resultados/3/training_batch_wer.png}
\end{frame}

\begin{frame}
     \centering
     \includegraphics[width=0.9\linewidth]{imagens/Resultados/3/val_wer.png}
\end{frame}

\begin{frame}{Segunda version}
         \centering
     \includegraphics[width=0.9\linewidth]{imagens/Resultados/12/training_batch_wer.png}
    
\end{frame}

\begin{frame}
         \centering
     \includegraphics[width=0.9\linewidth]{imagens/Resultados/12/val_wer.png}
