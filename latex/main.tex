...
\titlegraphic{\includegraphics[width=1cm]{img/logo_unam_negro.jpg}}
...
\begin{frame}{Nuestra Participación: \textit{Low-Resource} Track}
    ...
    \vspace{0.5cm}
    \centering
    \includegraphics[width=0.7\linewidth]{img/balanza.png}
\end{frame}
...
\begin{figure}[!tbp]
  ...
  \hfill
  \begin{minipage}[b]{0.45\textwidth}
    \includegraphics[width=\textwidth]{img/Graficas/quechua/avg_word_length.jpg}
    \caption{Quechua}
  \end{minipage}
\end{figure}
\end{frame}
...
\begin{figure}[!tbp]
  ...
  \hfill
  \begin{minipage}[b]{0.45\textwidth}
    \includegraphics[width=\textwidth]{img/Graficas/quechua/char_length.jpg}
    \caption{Quechua}
  \end{minipage}
\end{figure}
\end{frame}
...
\begin{figure}[!tbp]
  ...
  \hfill
  \begin{minipage}[b]{0.45\textwidth}
    \includegraphics[width=\textwidth]{img/Graficas/quechua/word_length.jpg}
    \caption{Quechua}
  \end{minipage}
\end{figure}
\end{frame}
...
\begin{frame}{Evidencia del registro}
 ...
 \begin{figure}
     \centering
     \includegraphics[width=0.8\linewidth]{img/registry.png}
 \end{figure}
