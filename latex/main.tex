...
\titlegraphic{\includegraphics[width=1cm]{imagens/logo_unam_negro.jpg}}
...
Dado que tenemos muy pocos datos, un \textit{Full Fine-Tuning} causaría \textbf{overfitting} y es computacionalmente costoso. Nuestra Solución: \pause

\huge \textbf{Parameter-Efficient Fine-Tuning (PEFT)}
...
\begin{itemize}
    ...
    \item <3-> \textbf{Estrategia específica:} Entrenaremos adapters en el \textit{Encoder} (para capturar la acústica de las nuevas lenguas) y, opcionalmente, en las capas de atención del \textit{Decoder}.
\end{itemize}
